...
interface Props {
  activeView: "mission" | "swarms" | "analytics" | "activities";
  onViewChange: (view: "mission" | "swarms" | "analytics" | "activities") => void;
}
  ...
  return (
    <aside className="mc-rail w-[60px] flex flex-col items-center py-4 border-r border-[#222] bg-[#0e0e0e]">
      ...
      <nav className="flex flex-col gap-1 flex-1 w-full">
        ...
        <a
          href="/teams"
          className={`relative flex items-center justify-center w-full h-10 transition-colors ${activeView === "swarms" ? "text-[#e85d27] bg-[#1a0f0a]" : "text-gray-500 hover:text-gray-200 hover:bg-[#1a1a1a]"}`}
          title="Agentic Teams"
        >
        ...
        <a
          href="/activities"
          className={`relative flex items-center justify-center w-full h-10 transition-colors ${activeView === "activities" ? "text-[#e85d27] bg-[#1a0f0a]" : "text-gray-500 hover:text-gray-200 hover:bg-[#1a1a1a]"}`}
          title="Activities"
        >
