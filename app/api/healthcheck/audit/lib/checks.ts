import type { RouterAgent, AuditFinding, SecurityCheck, PatternCheckDef } from "./types";
import { IDENTITY_FILES } from "./loader";
...
// Decode helpers (used by checkEncodingAttack)
...
export function checkExecPrivilege(agents: RouterAgent[]): SecurityCheck {
...
export function checkCredentials(agents: RouterAgent[], fileMap: Map<string, Map<string, string>>): SecurityCheck {
  const findings: AuditFinding[] = [];
...
export function checkSubagentCreation(agents: RouterAgent[], fileMap: Map<string, Map<string, string>>): SecurityCheck {
  const findings: AuditFinding[] = [];
...
export function checkSuspiciousContent(agents: RouterAgent[], fileMap: Map<string, Map<string, string>>): SecurityCheck {
  const findings: AuditFinding[] = [];
  const seen = new Set<string>();
...
export function checkDirectAgentAttack(agents: RouterAgent[], fileMap: Map<string, Map<string, string>>): SecurityCheck {
  const findings: AuditFinding[] = [];
...
export function checkEncodingAttack(agents: RouterAgent[], fileMap: Map<string, Map<string, string>>): SecurityCheck {
  const findings: AuditFinding[] = [];
  const seen = new Set<string>();
...
export const PERSONA_ATTACK_DEF: PatternCheckDef = {
...
export const SOCIAL_ATTACK_DEF: PatternCheckDef = {
...
export const CRESCENDO_ATTACK_DEF: PatternCheckDef = {
...
export const MANYSHOT_ATTACK_DEF: PatternCheckDef = {
...
export const COT_HIJACK_DEF: PatternCheckDef = {
...
export const POLICY_PUPPETRY_DEF: PatternCheckDef = {
...
export const INJECTION_ATTACK_DEF: PatternCheckDef = {
...
export const TOOL_EXPLOIT_DEF: PatternCheckDef = {
...
export const CREDENTIAL_EXTRACTION_DEF: PatternCheckDef = {
...
export const DATA_EXFILTRATION_DEF: PatternCheckDef = {
...
export const JAILBREAK_DEF: PatternCheckDef = {
...
// ── Check 20: Multi-turn manipulation ────────────────────────────────────────
...
export const MULTITURN_MANIPULATION_DEF: PatternCheckDef = {
...
export const CONTEXT_CONFUSION_DEF: PatternCheckDef = {
...
export const ROLE_HIJACK_DEF: PatternCheckDef = {
...
export const POLICY_BYPASS_DEF: PatternCheckDef = {
...
export const INDIRECT_INJECTION_DEF: PatternCheckDef = {
...
export const BOUNDARY_TESTING_DEF: PatternCheckDef = {
...
// Ordered list of all 17 pattern-check DEFs (checks 9–25)
export const PATTERN_CHECK_DEFS: PatternCheckDef[] = [
  PERSONA_ATTACK_DEF,
  SOCIAL_ATTACK_DEF,
